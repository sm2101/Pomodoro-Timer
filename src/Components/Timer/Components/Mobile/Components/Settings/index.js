...
import { Switch, SwipeableDrawer } from "@mui/material";
...
const SettingDrawer = () => {
  ...
  return (
    ...
    >
      <BlurBox id="setting-dialog" classNames="setting-box-mobile">
        <div id="setting-title">Settings</div>
        <div className="timer-input-group-mobile">
          <div className="timer-input-mobile">
            <StyledInput
              id="focus"
              type="number"
              label="Focus Time"
